...
anova(final_model, alt_final_model)
anova(alt_final_model, final_model)
...
The normal Q-Q plot serves as an indicator to detect deviance from normal distribution in residuals.
